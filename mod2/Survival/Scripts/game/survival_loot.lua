...
dofile( "$SURVIVAL_DATA/Scripts/RaMod.lua" )
...
local random_loot = {
	...
	{ uuid = obj_seed_carrot,				chance = 20,	quantity = 1 },
...
local random_epicloot = {
	...
	{ uuid = obj_consumable_component,		chance = 70,	quantity = randomStackAmountAvg2 },
	...
	{ uuid = obj_resource_circuitboard,		chance = 50,	quantity = randomStackAmountAvg2 },
...
local random_warehouseloot = {
	...
	{ uuid = obj_consumable_component,		chance = 70,	quantity = randomStackAmountAvg5 },
}

local random_officeloot = {
	{ uuid = obj_consumable_component,		chance = 10,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_resource_circuitboard,		chance = 10, 	quantity = randomStackAmountAvg5 },
	{ uuid = obj_consumable_battery,		chance = 10,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_consumable_sunshake, 		chance = 30, 	quantity = randomStackAmountAvg5 },
	...
	{ uuid = obj_consumable_glue,			chance = 65,	quantity = randomStackAmountAvg5 },
}
...
lootTables.loot_woc = {
	...
	randomLoot = {
	{ uuid = obj_resource_steak,				chance = 10 },
	}
}
...
lootTables.loot_woc_milk = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_milk,			chance = 10 },
	}
}
...
lootTables.loot_glow_goop = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_resource_glowpoop,			chance = 10 },
	}
}
...
lootTables.loot_totebot_green = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 1,		quantity = 5 },
...
lootTables.loot_haybot = {
	slots = 2,
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 1,		quantity = 10 },
...
lootTables.loot_tapebot = {
	slots = 3,
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 2,		quantity = 15 },
		{ uuid = obj_consumable_battery,		chance = 5,		quantity = 15 },
	}
}
...
lootTables.loot_farmbot = {
	slots = 3,
	selectOne = {
		{ uuid = obj_survivalobject_keycard,	chance = 1,		quantity = 1 },
	},
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 2,		quantity = 20 },
		{ uuid = obj_resource_circuitboard,		chance = 1,		quantity = 20 },
	}
}
...
function SpawnLoot( origin, lootList, worldPosition, ringAngle )
	...
	if worldPosition then
		for i = 1, #lootList do
			...
			-- 采集修改
			-- 如果是采集物品，直接数量*10
			if type( origin ) == "Harvestable" then
				params.lootQuantity = params.lootQuantity * RA_MOD_HARVESTABLE_LOOT_RATE
			end
