				...
				if type( result ) == "Harvestable" then
					...
					if not pubData or not pubData.harvested then
						...
						elseif result:getType() == "filler" then
							if pubData and pubData.uuid and pubData.quantity then
					...
					if sm.container.endTransaction() then
						...
						if incomingObject.harvestable then
							...
							elseif incomingObject.harvestable:getUuid() == hvs_farmables_pigmentflower then	
								...
								sm.harvestable.create( hvs_farmables_growing_pigmentflower, sm.harvestable.getPosition( incomingObject.harvestable ), sm.harvestable.getRotation( incomingObject.harvestable ) )
							elseif incomingObject.harvestable:getUuid() == hvs_farmables_cottonplant then
								...
								sm.harvestable.create( hvs_farmables_growing_cottonplant, sm.harvestable.getPosition( incomingObject.harvestable ), sm.harvestable.getRotation( incomingObject.harvestable ) )
